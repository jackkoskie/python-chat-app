from functions import addMessage, showCommandResult
from messages import getRoom, messages, setRoom
...
def runHelp(args):
  if (len(args) > 0):
    ...
    data = ['\n[b u]List of Commands[/]', '[i]Run [b blue]/help \[command name][/] to get more information about a command.[/]\n']
...
commands = [
  ...
  Command('room', 'Display the current room or set join a new room.', runRoom, '[room name]')
]